...
public class JournalPaperSynchronizeTest {
    ...
    public void testSynchronizeJuornalPaper() throws SQLException {
        ...
        Assert.assertEquals("Update with 19999 journal papers, total staff with no journal is 0", journalPaperSynchronize.synchronize_all_journal_papers_from_TEDB());
    }
}
