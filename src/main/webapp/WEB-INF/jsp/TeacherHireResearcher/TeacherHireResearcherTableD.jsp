...
<p style="font-weight:bold;font-size:20px;text-align: center;">績優教師執行第一期績效說明表(申請第二期者填寫)(表D)</p>
</div>
...
<%--            </tr>--%>
        ...
        <tbody >
            ...
            <tr>
                <td colspan="4" style="text-align: left;border-width:3px;border-color: #000000">近三年FWCI值<input name="fwci_value_past_five_year">,若為本校近三年FWCI值之1.5倍則加計點數10點(B)。</td>
            ...
            <tr>
                <td colspan="8" style="text-align: left;">
                    <p>說明事項：</p>
                    <p class="three_years" style="padding-left: 2rem;">1. <b>績優教師執行第一期</b>以本校名義發表之學術論著。</p>
