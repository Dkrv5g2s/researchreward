...
<%--            </tr>--%>
        ...
        <tbody >
            ...
            <tr>
                <td colspan="7" style="text-align: left;font-weight: bold;"><input type="checkbox" name="representationClause"><font color="red">申請人充分瞭解申請辦法，且上述資料與勾選事項皆屬實，若有誤願自行負完全的法律責任。</font><br>
                </td>
            </tr>
            <tr>
