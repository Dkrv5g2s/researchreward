...
<html>
<head>
    <title>ExcellentResearcherPrint</title>
...
<script type="text/javascript">
    ...
    function setIframeSrc(){
        document.getElementById("page1").src="PersonalInformation";
        document.getElementById("page2").src="RecruitDescription";
        document.getElementById("page3").src="CatalogOfWorks";
        document.getElementById("page4").src="ResearchProduction";
    }
