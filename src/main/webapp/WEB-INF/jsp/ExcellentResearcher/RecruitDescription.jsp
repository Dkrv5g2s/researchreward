        ...
        <form>
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="recruitReason" type="text" maxlength="200" required><%= json.get("recruitReason")%></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="metadata">延攬目標、執行方式及內容，申請單位對受延攬人提供之教學、研究及行政支援等相關配合措施。</td>
                    <td>
                        <textarea name="recruitContent" type="text" maxlength="200" required><%= json.get("recruitContent")%></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="metadata">預期達成之具體成果及績效、未來績效評估準則(例如對申請單位研究工作之助益、對於科技發展之貢獻或於經濟建設及其他應用面預期可獲致之效益、對產業技術升級或研究團隊養成之效益等)。</td>
                    <td>
                        <textarea name="expect" type="text" maxlength="200" required><%= json.get("expect")%></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="metadata">攬才情勢分析(含國際攬才情勢分析及申請單位攬才策略)。</td>
                    <td>
                        <textarea name="analysis" type="text" maxlength="200" required><%= json.get("analysis")%></textarea>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="award" type="text" maxlength="200" required><%= json.get("award")%></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="metadata">其他資料(例如：擔任國際重要學術學會理監事、國際知名學術期刊編輯/副編輯或評審委員、專利或技術移轉具體績效等)。</td>
                    <td>
                        <textarea name="other" type="text" maxlength="200" required><%= json.get("other")%></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="metadata">請簡述上述代表性研究成果內個人之重要貢獻。</td>
                    <td>
                        <textarea name="contribution" type="text" maxlength="200" required><%= json.get("contribution")%></textarea>
                    </td>
                </tr>
                <tr><td colspan="2" style="text-align: center; background-color: rgb(255, 255, 240)"><span><button type="button" onclick="commit()">存檔</button></span><span><input type="button" style="width:10%" value="上一頁" name="close" onclick="javascript:location.href='RewardList'"></span></td></tr>
                </tbody>
            </table>
        </form>
    </div>
