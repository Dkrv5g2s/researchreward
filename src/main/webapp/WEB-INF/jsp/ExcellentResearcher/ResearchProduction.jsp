...
<div class="content">
    ...
    <form id="form">
        ...
        <div>
            <table>
                <tbody>
                <tr><td colspan="2" style="text-align: center; background-color: rgb(255, 255, 240)"><span><button type="button" onclick="commit()">存檔</button></span><span><input class="back" type="button" width="10%" value="上一頁" name="close" onclick="javascript:location.href='RewardList'"></span></td></tr>
                </tbody>
            </table>
        </div>
    </form>
