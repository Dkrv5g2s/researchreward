...
<html>
<head>
    <title>陽光獎助金論文 學生 學術論著及FWCI計算</title>
</head>
<body>
<p style="text-align:center;font-weight:bold;font-size:20px;clear:none;">陽光獎助金論文 學生 學術論著及FWCI計算</p>
<form method="post" action="Plan?func=international_formC001" enctype="multipart/form-data" id="c001_form">
    <table border="1" cellpadding="5" cellspacing="1" width="100%" align="center" style="border-spacing:0px;" class="inputForm">
        ...
        <tr style="text-align:center;background:  #C0C0C0 ">
            ...
            <td rowspan="1" colspan="2" width="50%" style="text-align:left;">
                <input type="checkbox" name="Position1 ">
                <strong>期刊論文:請檢附表A「論文」績效說明表</strong><br>
                <input type="checkbox" name="Position2 "><strong>
                研討會論文:請檢附1.發表之研討會論文首頁 2.會議註冊證明
                3.研討會論文集封面<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4.研討會口頭發表現場佐證照片<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(相片內容須包含發表者、研討會現場及觀眾)</strong><br><br></td>
        </tr>
        <!-- 大列4 -->
        ...
        <tr style="text-align: left; ">
            <td rowspan="1 " colspan="6 " width="100% " style="font-weight: bold; ">
                ...
                <br><br><br> 申請人簽章: <input type="text" name="check_one "> 日期: <input type="text" name="check_one "><br><br> 指導教授簽名: <input type="text" name="check_one "> 日期: <input type="text" name="check_one "><br> <span style="font-style:normal; font-size: 12px; ">(請指導教授確實簽核，該篇論文僅一位同學提出申請)</span>
                <br>
