...
<head>
    ...
    <script>
        ...
        $( document ).ready(function() {
            // 在這撰寫javascript程式碼
            <%--$('#levels').val("<%=json.get("levels")%>");--%>
            <%--$('#ResignedTime').val("<%=json.get("ResignedTime")%>");--%>
    ...
    <form >
        <table border="1" cellpadding="5" cellspacing="1" width="100%" align="center" style="border-spacing:0px;" class="inputForm">
            ...
            <tr style="text-align: center;">
                ...
                <td width="10%" style="text-align: left;">中文:&nbsp;<input  name="chineseName" maxlength="40" value="<%=json.get("chinese_name")%>" ></td>
            </tr>
            <tr style="text-align: left;">
                <td width="10%">英文:&nbsp;<input name="englishName" maxlength="40" value="<%=json.get("english_name")%>" ></td>

            </tr>
            <tr style="text-align: left;">
                <td width="10%">身分證字號(ARC No.):&nbsp;<input name="nationalIDNumber" maxlength="40" value="<%=json.get("national_ID_number")%>" ></td>

            </tr>
            <!-- 大列2 -->
            <tr style="text-align: center;">
                <td rowspan="1" colspan="1" width="20%" style="font-size:22px"><strong>單位(系所):</strong></td>
                <td rowspan="1" colspan="0" width="38%" style="font-size:22px;text-align: left;"><input name="department" maxlength="40" value="<%=json.get("department")%>" ></td>
            </tr>
            ...
            <tr style="text-align: center;" id="FacultyTr">
                ...
                <td rowspan="1" colspan="1" width="20%" style="font-size:22px;text-align: left;" id="FacultyTable">
                    <select name="titles" size="1" id = "selectFacultyBox" onchange="changeFunc();" value="<%=json.get("titles")%>" >
            ...
            <tr style="text-align: center;">
                ...
                <td rowspan="1" colspan="0" width="20%" style="text-align: left;">研究室分機:&nbsp;<input name="extensionNumber" maxlength="15" value="<%=json.get("extension_number")%>" ></td>
            </tr>
            <tr style="text-align: center;">
                <td rowspan="1" colspan="0" width="20%" style="text-align: left;">手機:&nbsp;<input name="cellphoneNumber" maxlength="15" value="<%=json.get("cellphone_number")%>" ></td>
            </tr>
            <tr style="text-align: center;">
                <td rowspan="1" colspan="0" width="20%" style="text-align: left;">E-mail:&nbsp;<input name="emailAddress" maxlength="40" value="<%=json.get("email_address")%>" ></td>
            </tr>
            <tr>
