...
<form >
    <table border="1" cellpadding="5" cellspacing="1" width="100%" align="center" style="border-spacing:0px;" class="inputForm" >
        ...
        <tr style="text-align: center;">
            ...
            <td colspan="2" width="10%" style="text-align: left;">中文:&nbsp;<input  id="chineseName" maxlength="40" readonly></td>
        </tr>
        <tr style="text-align: left;">
            <td colspan="2" width="10%">英文:&nbsp;<input  id="englishName" maxlength="40" readonly></td>

        </tr>
        <tr style="text-align: left;">
            <td colspan="2" width="10%">身分證字號(ARC No.):&nbsp;<input  id="nationalIDNumber" maxlength="40" readonly></td>

        </tr>
        <!-- 大列2 -->
        <tr style="text-align: center;">
            <td rowspan="1" colspan="4" width="20%" style="font-size:22px"><strong>單位(系所):</strong></td>
            <td rowspan="1" colspan="2" width="38%" style="font-size:22px;text-align: left;"><input  id="department" maxlength="40" readonly></td>
        </tr>
        ...
        <tr style="text-align: center;" id="FacultyTr">
            ...
            <td rowspan="1" colspan="2" width="20%" style="font-size:13px;text-align: left;" id="FacultyTable">
                <select  size="1" id = "titles" onchange="changeFunc();"  disabled>
                ...
                <span id="StaffInput">職稱:&nbsp;<input id="levels" readonly ></span>
                <span id="ResignedMemberInput" style = "display : none ;">離職年月:&nbsp;<input id="resignedTime" type="date" readonly></span>
            </td>
        </tr>
        ...
        <tr style="text-align: center;">
            ...
            <td rowspan="1" colspan="2" width="20%" style="text-align: left;">研究室分機:&nbsp;<input  id="extensionNumber" maxlength="15" readonly></td>
        </tr>
        <tr style="text-align: center;">
            <td rowspan="1" colspan="2" width="20%" style="text-align: left;">手機:&nbsp;<input  id="cellphoneNumber" maxlength="15" readonly></td>
        </tr>
        <tr style="text-align: center;">
            <td rowspan="1" colspan="2" width="20%" style="text-align: left;">E-mail:&nbsp;<input  id="emailAddress" maxlength="40"  readonly></td>
        </tr>
        <%--           ^^ personal data--%>
        ...
        <tr style="text-align: center;">
            ...
            <td colspan="2" width="20%" style="text-align: left;"><strong>篇數: <input id="SWArticleCountOne" maxlength="5" readonly></strong></td>
        </tr>
        <tr style="text-align: center;">
            <td colspan="2" width="20%" style="text-align: left;"><strong>點數小計:  <input id="SWPointOne" maxlength="5" readonly></strong></td>
        </tr>
        ...
        <tr style="text-align: center;">
            <td rowspan="1" colspan="6" width="20%">
                ...
                <br>
                <p align="left">申請人近5年FWCI值:&nbsp;<input id="FWCIValueOfUser" maxlength="40" oninput="calculatePrize()" readonly>&nbsp;
                    為本校近五年FWCI值<span >${fwci}</span>之<span id="FWCIValueOfUserDivideNTUT"></span>倍。<br></p>
                <p align="left">申請人h-5指數:&nbsp;<input id="h5IndexOfUser" maxlength="40" oninput="calculatePrize()" readonly>&nbsp;
        ...
        <tr style="text-align: left; ">
            <td rowspan="1 " colspan="6 " width="100% " style="font-weight: bold; ">
                ...
                <br><br><br>
                申請日期:<input type="date" id="CommitDate" readonly>
        ...
        <tr>
            <td colspan="6" style="background-color:rgb(255, 255, 240);text-align: center">
                <button type="button" width="10%" onclick="javascript:location.href='SunshineScholarshipCatalog'">回目錄</button>
                <button type="button" width="10%" onclick="location.href='SunshineScholarshipAwardTableA'">此頁審查完成</button>
            </td>
        </tr>
        </tbody>
    </table>
