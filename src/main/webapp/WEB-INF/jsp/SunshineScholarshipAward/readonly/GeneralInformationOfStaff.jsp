    ...
    <form >
        <table border="1" cellpadding="5" cellspacing="1" width="100%" align="center" style="border-spacing:0px;" class="inputForm" >
            ...
            <tr style="text-align: center;">
                ...
                <td width="10%" style="text-align: left;">中文:&nbsp;<input  id="chineseName" maxlength="40" readonly></td>
            </tr>
            <tr style="text-align: left;">
                <td width="10%">英文:&nbsp;<input  id="englishName" maxlength="40" readonly></td>

            </tr>
            <tr style="text-align: left;">
                <td width="10%">身分證字號(ARC No.):&nbsp;<input  id="nationalIDNumber" maxlength="40" readonly></td>

            </tr>
            <!-- 大列2 -->
            <tr style="text-align: center;">
                <td rowspan="1" colspan="1" width="20%" style="font-size:22px"><strong>單位(系所):</strong></td>
                <td rowspan="1" colspan="0" width="38%" style="font-size:22px;text-align: left;"><input  id="department" maxlength="40" readonly></td>
            </tr>
            ...
            <tr style="text-align: center;">
                ...
                <td rowspan="1" colspan="0" width="20%" style="text-align: left;">研究室分機:&nbsp;<input  id="extensionNumber" maxlength="15" readonly></td>
            </tr>
            <tr style="text-align: center;">
                <td rowspan="1" colspan="0" width="20%" style="text-align: left;">手機:&nbsp;<input  id="cellphoneNumber" maxlength="15" readonly></td>
            </tr>
            <tr style="text-align: center;">
                <td rowspan="1" colspan="0" width="20%" style="text-align: left;">E-mail:&nbsp;<input  id="emailAddress" maxlength="40"  readonly></td>
            </tr>
<%--           ^^ personal data--%>
