...
<%--            <button type="button" onclick="location.href='JuniorResearchInvestigatorTableA'">此頁審查完成</button>--%>
            <button type="button" onclick="location.href='JuniorResearchInvestigatorTableA'">下一頁</button>
        </div>
    </form>
</div>
</body>
