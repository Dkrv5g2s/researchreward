...
<div class="container">
    <p style="font-weight:bold;font-size:20px;text-align: center;">年輕學者研究獎 傑出論文績效說明表</p>
</div>
...
<script>
    ...
    function dataFromTable(){
        ...
        latest_data["fwci_value_past_five_year"] = $('input[name="fwci_value_past_five_year"]').val();  //fwci_value_past_three_years
        latest_data["fwci_value_past_five_year"] = $('label[id="total_point"]').text();  //fwci_value_past_three_years
