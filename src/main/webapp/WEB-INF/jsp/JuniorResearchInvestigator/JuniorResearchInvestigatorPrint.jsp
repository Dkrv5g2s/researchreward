...
<script type="text/javascript">
    ...
    function setIframeSrc(){
        document.getElementById("page1").src="JuniorResearchInvestigator";
        document.getElementById("page2").src="JuniorResearchInvestigatorReviewInformation";
        document.getElementById("page3").src="JuniorResearchInvestigatorTableA";
        document.getElementById("page4").src="JuniorResearchInvestigatorTableB";
    }
