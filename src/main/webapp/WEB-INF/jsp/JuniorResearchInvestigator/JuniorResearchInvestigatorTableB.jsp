...
<div class="content">
    <form>
        <p style="text-align: center;font-size: 24px;font-weight: bold;">年輕學者研究獎 附件B 國立臺北科技大學傑出論文績效說明表</p>
        <table border="1" cellpadding="6" cellspacing="1" width="100%" align="center" style="border-spacing:0px;" class="inputForm">
            ...
            <tr>
                <td colspan="8" style="text-align: left;">說明事項：<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;1.近三年以本校名義發表之學術論著（此段期間曾生產或請育嬰假者得以延長，其延長期限依實際請假時間為依據，並檢附相關證明文件）始得採計。<br>
