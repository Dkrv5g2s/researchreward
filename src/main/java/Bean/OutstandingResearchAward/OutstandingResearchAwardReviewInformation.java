...
public class OutstandingResearchAwardReviewInformation {
...
//    private List<JuniorResearchInvestigatorReviewInformation> juniorResearchInvestigatorReviewInformationList = new ArrayList<>();
    ...
    public OutstandingResearchAwardReviewInformation(int projectId, int userNumber, String technologyTransferContractName, String technologyTransferDepartment, Date contractDate, String technologyTransferFund, Date technologyTransferFundBringInDate) {
    ...
    public OutstandingResearchAwardReviewInformation() {}
