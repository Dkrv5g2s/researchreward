...
import Dao.JuniorResearchInvestigator.JuniorResearchInvestigatorTableA.TechTransferDAO;
...
public class TechTransferDAOImpl implements TechTransferDAO {
    ...
    public void insert(Connection connection,TechTransfer object,String projectID) {
        try (PreparedStatement preparedStatement = connection.prepareStatement(INSERT))
        {
            ...
            preparedStatement.setString(5,object.getTech_transfer_count_total());
            preparedStatement.setString(6,object.getTech_transfer_management1());
            preparedStatement.setString(7,object.getTech_transfer_management2());
            preparedStatement.setString(8,object.getTech_transfer_management3());
            preparedStatement.setString(9,object.getTech_transfer_management_total());
            preparedStatement.setString(10,object.getTech_transfer_money1());
            preparedStatement.setString(11,object.getTech_transfer_money2());
            preparedStatement.setString(12,object.getTech_transfer_money3());
            preparedStatement.setString(13,object.getTech_transfer_money_total());
            preparedStatement.setString(14,object.getTech_transfer_point1());
            preparedStatement.setString(15,object.getTech_transfer_point2());
            preparedStatement.setString(16,object.getTech_transfer_point3());
            preparedStatement.setString(17,object.getTech_transfer_point_total());
    ...
    public void update(Connection connection,TechTransfer object,String projectID) {
        try (PreparedStatement preparedStatement = connection.prepareStatement(UPDATE))
        {
            ...
            preparedStatement.setString(4,object.getTech_transfer_count_total());
            preparedStatement.setString(5,object.getTech_transfer_management1());
            preparedStatement.setString(6,object.getTech_transfer_management2());
            preparedStatement.setString(7,object.getTech_transfer_management3());
            preparedStatement.setString(8,object.getTech_transfer_management_total());
            preparedStatement.setString(9,object.getTech_transfer_money1());
            preparedStatement.setString(10,object.getTech_transfer_money2());
            preparedStatement.setString(11,object.getTech_transfer_money3());
            preparedStatement.setString(12,object.getTech_transfer_money_total());
            preparedStatement.setString(13,object.getTech_transfer_point1());
            preparedStatement.setString(14,object.getTech_transfer_point2());
            preparedStatement.setString(15,object.getTech_transfer_point3());
            preparedStatement.setString(16,object.getTech_transfer_point_total());
