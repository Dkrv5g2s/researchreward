...
import Dao.OutstandingResearchAward.OutstandingResearchAwardTableA.OtherDataDAO;
...
public class OtherDataDAOImpl implements OtherDataDAO {
    ...
    private static final String INSERT =
            "INSERT INTO otherdata (projectID,year1,year2,year3,other_data,declaration,commit_date)" +
                    " values(?,?,?,?,?,?,?)";
    ...
    @Override
    public OtherData get(String projectID) {
        Connection connection = dbConnection.getConnection();
        ResultSet resultSet = null;
        try (PreparedStatement preparedStatement = connection.prepareStatement(SELECT))
        {
