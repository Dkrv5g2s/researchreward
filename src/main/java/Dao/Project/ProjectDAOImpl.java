...
public class ProjectDAOImpl implements ProjectDAO {
    ...
    private static final String ADMINS_GET_PROJECT = "SELECT * FROM reward_project WHERE status=?";
    ...
    public List<RewardProject> adminsGetProjects(String status) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(ADMINS_GET_PROJECT))
        {
            preparedStatement.setString(1,status);
