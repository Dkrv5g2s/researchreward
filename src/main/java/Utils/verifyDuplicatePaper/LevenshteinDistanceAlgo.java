...
// Ref : https://www.cnblogs.com/ivanyb/archive/2011/11/25/2263356.html
public class LevenshteinDistanceAlgo {
    ...
    private int implLevenshteinDistance(String str1, String str2) {
        int[][] d; // 矩阵
        int n = str1.length();
        int m = str2.length();
...
//        System.out.println("str2:"+str2);
    ...
    public double getNormalizedSimilarity(String str1, String str2) {
        try {
            double ld = implLevenshteinDistance(str1, str2);
//            System.out.println("STEPS:"+ld);
