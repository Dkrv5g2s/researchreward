...
public class PersonalInformationServlet extends ServletEntryPoint {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("json",personalInformationService.get((String)session.getAttribute("projectId")));
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        personalInformationService.save(json,(String)session.getAttribute("projectId"));
