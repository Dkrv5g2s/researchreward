...
public class RecruitDescriptionServlet extends ServletEntryPoint {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("json",recruitDescriptionService.get((String)session.getAttribute("projectId")));
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        recruitDescriptionService.save(json,(String)session.getAttribute("projectId"));
